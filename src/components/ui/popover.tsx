  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          'z-50 w-72 origin-[--radix-popover-content-transform-origin] rounded-[15px] border border-[#f2f4f4] bg-white shadow-[0_8px_32px_rgba(45,52,53,0.12)] outline-none',
...
function PopoverTitle({ className, ...props }: React.ComponentProps<'p'>) {
  return <p className={cn('text-sm font-semibold text-[#2d3435]', className)} {...props} />;
}
