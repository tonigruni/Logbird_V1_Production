  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <h4 className="text-xs font-bold text-[#1F3649] leading-snug">{task.title}</h4>
  ...
  return (
    <div className="bg-white card p-3 flex items-start gap-2.5 shadow-xl rotate-2 w-64 opacity-90">
      ...
      <div className="flex-1 min-w-0">
        ...
        <h4 className="text-xs font-bold text-[#1F3649] leading-snug mt-1">{task.title}</h4>
        {task.estimated_minutes && (
  ...
  return (
    ...
    >
      <div className="px-3 py-2 h-full flex flex-col justify-between">
        <div>
          <h4 className="text-xs font-bold text-[#1F3649] leading-snug truncate">{block.title}</h4>
          {height > 40 && (
          ...
          <div className="flex items-center gap-2">
            ...
            {block.energy && (
              <div className="flex items-center gap-0.5">
                {[1, 2, 3].map(i => (
                  <Lightning key={i} size={8} weight="fill" className={i <= block.energy! ? 'text-[#f59e0b]' : 'text-[#ebeeef]'} />
                ))}
              </div>
            )}
          </div>
    ...
    <DndContext sensors={sensors} onDragStart={handleDragStart} onDragOver={handleDragOver} onDragEnd={handleDragEnd}>
      <div className="space-y-6 pb-24">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div>
            <h2 className="text-base font-bold text-[#1F3649] tracking-tight">Calendar & Timeboxing</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[260px_1fr_240px] gap-5">
          ...
          <UnscheduledDropZone isOver={overSlot === 'unscheduled-panel'}>
            <div className="bg-white card p-4">
              <h3 className="text-xs font-bold text-[#1F3649] mb-1">Unscheduled</h3>
          ...
          <div className="bg-white card overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-[#f2f4f4]">
              <h3 className="text-sm font-bold text-[#1F3649]">{formatDateTitle(currentDate)}</h3>
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-1">
                  <button onClick={goPrev} className="p-1.5 hover:bg-[#f2f4f4] rounded-[8px] transition-colors cursor-pointer">
                    <CaretLeft size={14} className="text-[#5a6061]" />
                  </button>
                  <button
                    onClick={goToday}
                    className="px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-[#5a6061] hover:bg-[#f2f4f4] rounded-[8px] transition-colors cursor-pointer"
                  >
                    Today
                  </button>
                  <button onClick={goNext} className="p-1.5 hover:bg-[#f2f4f4] rounded-[8px] transition-colors cursor-pointer">
                    <CaretRight size={14} className="text-[#5a6061]" />
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white card p-5 space-y-3">
              ...
              <p className="text-[10px] text-[#5a6061] leading-relaxed">
                You&apos;ve planned <strong className="text-[#1F3649]">{focusHours} hours</strong> of focused work today.
                {Number(focusHours) >= 4
                  ? ' Great planning!'
                  ...
                  {workloadBreakdown.map(item => (
                    <div key={item.label}>
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-semibold text-[#1F3649]">{item.label}</span>
            ...
            <div className="bg-white card p-5 space-y-3">
              ...
              <p className="text-xs text-[#5a6061] leading-relaxed">
                Your productivity peaks between <strong className="text-[#1F3649]">9 AM and 11 AM</strong>.
            ...
            <div className="bg-white card p-5 text-center">
              ...
              <span className="text-2xl font-black text-[#1F3649] tracking-tight">
