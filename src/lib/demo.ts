...
export const DEMO_TASKS: Task[] = [
  {
    id: 'tk1', user_id: 'demo-user-id', goal_id: 'g1', category_id: 'c1',
    title: 'Gym session — upper body', completed: true,
    due_date: new Date().toISOString().split('T')[0],
    created_at: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'tk2', user_id: 'demo-user-id', goal_id: 'g1', category_id: 'c1',
    title: 'Meal prep for the week', completed: false,
    due_date: new Date().toISOString().split('T')[0],
    created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'tk3', user_id: 'demo-user-id', goal_id: 'g2', category_id: 'c2',
    title: 'Write landing page copy', completed: false,
    due_date: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    created_at: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: 'tk4', user_id: 'demo-user-id', goal_id: 'g2', category_id: 'c2',
